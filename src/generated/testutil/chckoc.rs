...
pub fn CHCKOC(
    ...
    if fstr::eq(ORDER, b"=") {
        {
            ...
            for _ in 0..((m2__ - m1__ + m3__) / m3__) as i32 {
                FAIL = (FAIL || !fstr::eq(ARRAY.get(I), ARRAY.get((I + 1))));
    ...
    } else if fstr::eq(ORDER, b"<") {
        {
            ...
            I = m1__;
            for _ in 0..((m2__ - m1__ + m3__) / m3__) as i32 {
                FAIL = (FAIL || !fstr::lt(&ARRAY[I], &ARRAY[(I + 1)]));
                I += m3__;
            }
        }
    ...
    } else if fstr::eq(ORDER, b"<=") {
        {
            ...
            I = m1__;
            for _ in 0..((m2__ - m1__ + m3__) / m3__) as i32 {
                FAIL = (FAIL || !fstr::le(&ARRAY[I], &ARRAY[(I + 1)]));
                I += m3__;
            }
        }
    ...
    } else if fstr::eq(ORDER, b">") {
        {
            ...
            I = m1__;
            for _ in 0..((m2__ - m1__ + m3__) / m3__) as i32 {
                FAIL = (FAIL || !fstr::gt(&ARRAY[I], &ARRAY[(I + 1)]));
                I += m3__;
            }
        }
    ...
    } else if fstr::eq(ORDER, b"=>") {
        {
            ...
            I = m1__;
            for _ in 0..((m2__ - m1__ + m3__) / m3__) as i32 {
                FAIL = (FAIL || !fstr::ge(&ARRAY[I], &ARRAY[(I + 1)]));
                I += m3__;
            }
        }
    ...
    if FAIL {
        ...
        spicelib::REPMI(&MESSGE.clone(), b"$", (J + 1), &mut MESSGE, ctx);
        spicelib::REPMC(&MESSGE.clone(), b"%", &ARRAY[J], &mut MESSGE);
        spicelib::REPMC(&MESSGE.clone(), b"&", &ARRAY[(J + 1)], &mut MESSGE);
