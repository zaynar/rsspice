...
//$Procedure F_GFSPRP ( Test GF angular separation progress reporting )
pub fn F_GFSPRP(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    testutil::NATSPK(NSPK, true, &mut save.HANDLE, ctx)?;
    testutil::CHCKXC(false, b" ", OK, ctx)?;
    ...
    //
    testutil::TCASE(
        b"Run an angular separation LOCMIN search using GFEVNT.",
        ctx,
    )?;
    ...
    fstr::assign(&mut save.GQUANT, b"ANGULAR SEPARATION");
    ...
    fstr::assign(save.QPNAMS.get_mut(9), b"REFERENCE FRAME");

    fstr::assign(save.QCPARS.get_mut(1), b"ALPHA");
    fstr::assign(save.QCPARS.get_mut(2), b" ");
    fstr::assign(save.QCPARS.get_mut(3), b"POINT");
    fstr::assign(save.QCPARS.get_mut(4), b"BETA");
    fstr::assign(save.QCPARS.get_mut(5), b"  ");
    fstr::assign(save.QCPARS.get_mut(6), b"POINT");
    ...
    for I in 1..=save.NPASS {
        ...
        fstr::assign(&mut save.XPREFX, b"Angular separation pass * of 1");
    ...
    //
    testutil::TCASE(
        b"Run an angular separation ABSMIN search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    testutil::TCASE(
        b"Run an angular separation LOCMAX search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    testutil::TCASE(
        b"Run an angular separation ABSMAX search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    testutil::TCASE(
        b"Run an angular separation > inequality search using GFEVNT.",
        ctx,
    )?;
    ...
    for I in 1..=save.NPASS {
        ...
        fstr::assign(&mut save.XPREFX, b"Angular separation pass * of 2");
        spicelib::REPMI(&save.XPREFX.to_vec(), b"*", I, &mut save.XPREFX, ctx);
        testutil::CHCKXC(false, b" ", OK, ctx)?;
    ...
    //
    // Angular separation inequality searches require 2 passes.
    //
    ...
    //
    testutil::TCASE(
        b"Run an angular separation equality search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    // Angular separation equality searches require 2 passes.
    //
    testutil::CHCKSI(b"No. of T_GFRTRM calls", save.NCALLS, b"=", 2, 0, OK, ctx)?;
    ...
    //
    testutil::TCASE(
        b"Run an angular separation adjusted ABSMIN search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    // Angular separation adjusted absolute extrema searches require 2
    // passes.
    //
    testutil::CHCKSI(b"No. of T_GFRTRM calls", save.NCALLS, b"=", 2, 0, OK, ctx)?;
    ...
    //
    testutil::TCASE(
        b"Run an angular separation adjusted ABSMAX search using GFEVNT.",
        ctx,
    )?;
