...
const CORLEN: i32 = 5;
const SPK: &[u8] = b"gfposc.bsp";
const PCK: &[u8] = b"gfposc.pck";
...
impl SaveInit for SaveVars {
    fn new() -> Self {
        ...
        let mut FRAME = vec![b' '; BDNMLN as usize];
        ...
        let mut MREFS = StackArray::<f64, 14>::new(1..=NDESC);
...
//$Procedure F_GFPOSC ( GFPOSC family tests )
pub fn F_GFPOSC(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    for I in 1..=2 {
        ...
        fstr::assign(&mut save.FRAME, b"X");
    ...
    fstr::assign(
        save.MDESC.get_mut(2),
        b"RECTANGULAR   : Y               : <",
    );
    fstr::assign(
        save.MDESC.get_mut(3),
        b"LATITUDINAL   : LONGITUDE       : <",
    );
    fstr::assign(
        save.MDESC.get_mut(4),
        b"RA/DEC        : RIGHT ASCENSION : >",
    );
    fstr::assign(
        save.MDESC.get_mut(5),
        b"SPHERICAL     : LONGITUDE       : <",
    );
    fstr::assign(
        save.MDESC.get_mut(6),
        b"CYLINDRICAL   : LONGITUDE       : >",
    );
    fstr::assign(
        save.MDESC.get_mut(7),
        b"LATITUDINAL   : LONGITUDE       : =",
    );
    fstr::assign(
        save.MDESC.get_mut(8),
        b"SPHERICAL     : LONGITUDE       : >",
    );
    fstr::assign(
        save.MDESC.get_mut(9),
        b"RECTANGULAR   : X               : LOCMAX",
    );
    fstr::assign(
        save.MDESC.get_mut(10),
        b"RECTANGULAR   : Y               : LOCMAX",
    );
    fstr::assign(
        save.MDESC.get_mut(11),
        b"RECTANGULAR   : X               : LOCMIN",
    );
    fstr::assign(
        save.MDESC.get_mut(12),
        b"RECTANGULAR   : Y               : LOCMIN",
    );
    fstr::assign(
        save.MDESC.get_mut(13),
        b"SPHERICAL     : LONGITUDE       : =",
    );
    fstr::assign(
        save.MDESC.get_mut(14),
        b"RA/DEC        : RIGHT ASCENSION : =",
    );
    ...
    save.MREFS[7] = (179.0 * spicelib::RPD(ctx));
    save.MREFS[8] = (179.0 * spicelib::RPD(ctx));
    save.MREFS[9] = 0.0;
    save.MREFS[10] = 0.0;
    save.MREFS[11] = 0.0;
    save.MREFS[12] = 0.0;
    save.MREFS[13] = (90.0 * spicelib::RPD(ctx));
    save.MREFS[14] = (359.0 * spicelib::RPD(ctx));
    ...
    fstr::assign(&mut save.FRAME, b"ALPHAFIXED");
    ...
    save.MREFS[1] = (270.0 * spicelib::RPD(ctx));
