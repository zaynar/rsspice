...
pub fn F_SPKGPS(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    let mut XFORM1 = StackArray2D::<f64, 9>::new(1..=3, 1..=3);
    let mut XFORM2 = StackArray2D::<f64, 9>::new(1..=3, 1..=3);
    let mut XFORM3 = StackArray2D::<f64, 9>::new(1..=3, 1..=3);
    let mut XFORM4 = StackArray2D::<f64, 9>::new(1..=3, 1..=3);
    let mut XFORM5 = StackArray2D::<f64, 9>::new(1..=3, 1..=3);
    let mut XFORM6 = StackArray2D::<f64, 9>::new(1..=3, 1..=3);
    let mut XFORM7 = StackArray2D::<f64, 9>::new(1..=3, 1..=3);
    let mut STXFRM = StackArray2D::<f64, 9>::new(1..=3, 1..=3);
    ...
    spicelib::SPKGPS(-10, ET, b"J2000", 399, STATE.as_slice_mut(), &mut LT, ctx)?;
    ...
    spicelib::SPKGEO(301, ET, b"J2000", 399, STATE1.as_slice_mut(), &mut LT2, ctx)?;
    spicelib::TIPBOD(b"J2000", 399, ET, TSIPM.as_slice_mut(), ctx)?;
    spicelib::MXV(TSIPM.as_slice(), STATE1.as_slice(), STATE2.as_slice_mut());
    ...
    spicelib::SPKGEO(301, ET, b"J2000", 399, STATE1.as_slice_mut(), &mut LT2, ctx)?;
    spicelib::TIPBOD(b"J2000", 499, ET, XFORM.as_slice_mut(), ctx)?;
    spicelib::MXV(XFORM.as_slice(), STATE1.as_slice(), STATE2.as_slice_mut());
    ...
    testutil::TCASE(b"Compute the state of body -9 relative to 401 in the IAU_EARTH frame using SPKGPS and computed via TSTST. ", ctx)?;
    ...
    spicelib::REFCHG(REF1, IAUE, ET, XFORM1.as_slice_mut(), ctx)?;
    spicelib::REFCHG(REF2, IAUE, ET, XFORM2.as_slice_mut(), ctx)?;
    spicelib::REFCHG(REF3, IAUE, ET, XFORM3.as_slice_mut(), ctx)?;
    spicelib::REFCHG(REF4, IAUE, ET, XFORM4.as_slice_mut(), ctx)?;
    spicelib::REFCHG(REF5, IAUE, ET, XFORM5.as_slice_mut(), ctx)?;
    spicelib::REFCHG(REF6, IAUE, ET, XFORM6.as_slice_mut(), ctx)?;
    spicelib::REFCHG(REF7, IAUE, ET, XFORM7.as_slice_mut(), ctx)?;

    spicelib::MXV(XFORM1.as_slice(), STATE1.as_slice(), IAUST1.as_slice_mut());
    spicelib::MXV(XFORM2.as_slice(), STATE2.as_slice(), IAUST2.as_slice_mut());
    spicelib::MXV(XFORM3.as_slice(), STATE3.as_slice(), IAUST3.as_slice_mut());
    spicelib::MXV(XFORM4.as_slice(), STATE4.as_slice(), IAUST4.as_slice_mut());
    spicelib::MXV(XFORM5.as_slice(), STATE5.as_slice(), IAUST5.as_slice_mut());
    spicelib::MXV(XFORM6.as_slice(), STATE6.as_slice(), IAUST6.as_slice_mut());
    spicelib::MXV(XFORM7.as_slice(), STATE7.as_slice(), IAUST7.as_slice_mut());

    spicelib::CLEARD(3, STATE1.as_slice_mut());
    spicelib::CLEARD(3, STATE2.as_slice_mut());
    ...
    spicelib::VSUB(STATE1.as_slice(), STATE2.as_slice(), STATE3.as_slice_mut());
    ...
    testutil::TCASE(b"Compare states as generated with the old version of SPKGEO with SPKGPS. This case uses a long ephemeris and a large variety of observer-target pairs.", ctx)?;
    //
    ...
    for REFID in intrinsics::range(1, 18, 5) {
        ...
        for J in intrinsics::range(1, 46, 10) {
            for K in intrinsics::range(46, 1, -3) {
                ...
                spicelib::SPKGPS(TARG, ET, &REF, OBS, STATE.as_slice_mut(), &mut LT, ctx)?;
                spicelib::SPKGEO(TARG, ET, &REF, OBS, STATE2.as_slice_mut(), &mut LT2, ctx)?;
    ...
    spicelib::REFCHG(IAUE, 1000023, ET, STXFRM.as_slice_mut(), ctx)?;
    spicelib::MXV(STXFRM.as_slice(), STATE.as_slice(), STATE2.as_slice_mut());
