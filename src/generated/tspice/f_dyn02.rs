...
pub fn F_DYN02(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    for CASE in 1..=NCART {
        ...
        if GO {
            ...
            //
            fstr::assign(&mut FRNAME, b"MEAN_OF_DATE_DYN_FRAME");
            FRCODE = -2000000000;
            ...
            testutil::CHCKXC(false, b" ", OK, ctx)?;
            spicelib::MXMT(RJ2B.as_slice(), PRECM.as_slice(), R2.as_slice_mut());
