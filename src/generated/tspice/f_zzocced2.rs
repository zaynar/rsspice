...
//$Procedure      F_ZZOCCED2 ( Test ellipsoid occultation routine )
pub fn F_ZZOCCED2(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    //
    testutil::TOPEN(b"F_ZZOCCED2", ctx)?;
    ...
    testutil::CHCKSI(b"T_OCCED", CODE, b"=", XCODE, 0, OK, ctx)?;
    ...
    // T_OCCED that deal with cases where the maximum angular separation
    ...
    // transformation performed by T_OCCED doesn't change the shape of
    // either target.
    //
    SEMAX2[[1, 1]] = 10.0;
    SEMAX2[[2, 1]] = 0.0;
