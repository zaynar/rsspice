...
pub fn F_SXFORM(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    let mut EFORM = StackArray2D::<f64, 36>::new(1..=6, 1..=6);
    let mut ET: f64 = 0.0;
    ...
    let mut TEMP1 = StackArray2D::<f64, 36>::new(1..=6, 1..=6);
    ...
    testutil::TCASE(b"Examine the exception produced by SXFORM", ctx)?;

    ET = -100000000.0;

    spicelib::SXFORM(b"SPUD", b"SPAM", ET, XFORM.as_slice_mut(), ctx)?;
    ...
    for I in 1..=18 {
        for J in 1..=18 {
            ...
            spicelib::SXFORM(&NAMEI, &NAMEJ, ET, XFORM.as_slice_mut(), ctx)?;
    ...
    for I in 1..=24 {
        ...
        spicelib::SXFORM(b"J2000", &NAME[I], ET, XFORM.as_slice_mut(), ctx)?;
        spicelib::TISBOD(b"J2000", IDCODE[I], ET, TSIPM.as_slice_mut(), ctx)?;
    ...
    for I in 1..=24 {
        ...
        spicelib::SXFORM(&NAME[I], b"J2000", ET, XFORM.as_slice_mut(), ctx)?;
        spicelib::TISBOD(b"J2000", IDCODE[I], ET, TEMP.as_slice_mut(), ctx)?;
        spicelib::INVSTM(TEMP.as_slice(), TSIPM.as_slice_mut(), ctx)?;
    ...
    for I in 1..=24 {
        for J in 1..=24 {
            ...
            spicelib::TISBOD(b"J2000", IDCODE[I], ET, TEMP1.as_slice_mut(), ctx)?;
            spicelib::INVSTM(TEMP1.as_slice(), TSPMI.as_slice_mut(), ctx)?;

            spicelib::TISBOD(b"J2000", IDCODE[J], ET, TSIPM.as_slice_mut(), ctx)?;
            ...
            spicelib::SXFORM(&NAME[I], &NAME[J], ET, XFORM.as_slice_mut(), ctx)?;
    ...
    spicelib::FRMCHG(TOPO, PHNX, ET, EFORM.as_slice_mut(), ctx)?;
