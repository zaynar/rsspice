...
pub fn F_RDPCK(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    fstr::assign(&mut save.PCK, b"test_0011.tpc");
    ...
    //
    testutil::T_PCK11(&save.PCK, true, true, ctx)?;
    ...
    testutil::T_PCKAST(save.XSET.as_slice_mut(), ctx)?;
    testutil::CHCKXC(false, b" ", OK, ctx)?;
    ...
    testutil::T_PCKRST(save.XSET.as_slice_mut(), ctx)?;
    testutil::CHCKXC(false, b" ", OK, ctx)?;
    ...
    //
    {
        ...
        for _ in 0..((m2__ - m1__ + m3__) / m3__) as i32 {
            ...
            testutil::T_PCKRAD(save.XSET[save.I], save.XRAD.as_slice_mut(), ctx)?;
            testutil::CHCKXC(false, b" ", OK, ctx)?;
