...
const CORLEN: i32 = 5;
const DSK0: &[u8] = b"illumg_dsk0.bds";
const DSK1: &[u8] = b"illumg_dsk1.bds";
const DSK2: &[u8] = b"illumg_dsk2.bds";
const DSK3: &[u8] = b"illumg_dsk3.bds";
const PCK: &[u8] = b"test_0008.tpc";
const SPK1: &[u8] = b"illumg_spk.bsp";
...
pub fn F_ILLUMG(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
