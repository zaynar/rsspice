...
//$Procedure F_NNEK04 ( EK tests, subset 4 )
pub fn F_NNEK04(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    // Open a new EK.
    //
    spicelib::EKOPN(EK1NAT, EK1NAT, 0, &mut save.HANDLE, ctx)?;
    testutil::CHCKXC(false, b" ", OK, ctx)?;
    ...
    // --- Case: ------------------------------------------------------
    //
    testutil::TCASE(b"Load non-native EK for read access using EKLEF.", ctx)?;
