...
//$Procedure      T_DASA2L ( DAS, address to physical location )
pub fn T_DASA2L(
    HANDLE: i32,
    TYPE: i32,
    ADDRSS: i32,
    ...
    //
    // Forward directory pointer location:
    //
    ...
    //
    // Indices of highest address in a `range array':
    //
    ...
    if ((TYPE < CHAR) || (TYPE > INT)) {
        ...
        spicelib::CHKOUT(b"T_DASA2L", ctx)?;
        return Ok(());
    }
    ...
    if save.FIRST {
        ...
        save.SAMFIL = (HANDLE == save.PRVHAN);
        save.PRVHAN = HANDLE;
    }
        ...
        *CLSIZE = save.TBSIZE[[TYPE, save.FIDX]];
        ...
        if !(save.KNOWN && save.FAST) {
            if !save.KNOWN {
                ...
                //
                if (save.NFILES < MAXFIL) {
                    save.NFILES = (save.NFILES + 1);
                    save.FIDX = save.NFILES;
                } else {
                    save.FIDX = 1;
                }
            ...
            // file.
            //
            save.NREC = ((save.NRESVR + save.NCOMR) + 2);
            save.NDIRS = 1;
            ...
            *CLSIZE = 0;
            ...
            while (save.HIADDR < ADDRSS) {
                ...
                *CLBASE = (*CLBASE + *CLSIZE);
                ...
                if (save.CURTYP == TYPE) {
                    save.HIADDR =
                        (save.HIADDR + (save.NW[TYPE] * i32::abs(save.DIRREC[save.DSCLOC])));
                }
            ...
            if (save.RDONLY && !save.KNOWN) {
                if (save.NDIRS == 1) {
                    ...
                    //
                    save.MXCLRC = (save.NREC + 1);
                    save.PRVTYP = save.PREV[save.DIRREC[BEGDSC]];
                    save.DSCLOC = (BEGDSC + 1);
                    save.FAST = true;

                    while ((save.DSCLOC <= (BEGDSC + save.NTYPES)) && save.FAST) {
                        //
                        // Find the type of the current descriptor.
                        //
                        if (save.DIRREC[save.DSCLOC] > 0) {
                        ...
                        save.PRVTYP = save.CURTYP;
                        save.TBBASE[[save.CURTYP, save.FIDX]] = save.MXCLRC;
                        save.TBSIZE[[save.CURTYP, save.FIDX]] = i32::abs(save.DIRREC[save.DSCLOC]);
                        save.MXCLRC = (save.MXCLRC + save.TBSIZE[[save.CURTYP, save.FIDX]]);

                        save.FAST = (save.TBMXAD[[save.CURTYP, save.FIDX]]
