...
pub fn F_GFDIRP(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    //---- Case -------------------------------------------------------------
    //
    testutil::TCASE(b"Run a distance LOCMIN search using GFEVNT.", ctx)?;
    ...
    fstr::assign(&mut save.GQUANT, b"DISTANCE");
    ...
    for I in 1..=save.NPASS {
        ...
        fstr::assign(&mut save.XPREFX, b"Distance pass * of 1");
    ...
    //---- Case -------------------------------------------------------------
    //
    testutil::TCASE(b"Run a distance ABSMIN search using GFEVNT.", ctx)?;
    ...
    //---- Case -------------------------------------------------------------
    //
    testutil::TCASE(b"Run a distance LOCMAX search using GFEVNT.", ctx)?;
    ...
    //---- Case -------------------------------------------------------------
    //
    testutil::TCASE(b"Run a distance ABSMAX search using GFEVNT.", ctx)?;
    ...
    //---- Case -------------------------------------------------------------
    //
    testutil::TCASE(b"Run a distance > inequality search using GFEVNT.", ctx)?;
    ...
    for I in 1..=save.NPASS {
        ...
        fstr::assign(&mut save.XPREFX, b"Distance pass * of 2");
        spicelib::REPMI(&save.XPREFX.to_vec(), b"*", I, &mut save.XPREFX, ctx);
        testutil::CHCKXC(false, b" ", OK, ctx)?;
    ...
    //---- Case -------------------------------------------------------------
    //
    testutil::TCASE(b"Run a distance equality search using GFEVNT.", ctx)?;
    ...
    //---- Case -------------------------------------------------------------
    //
    testutil::TCASE(b"Run a distance adjusted ABSMIN search using GFEVNT.", ctx)?;
    ...
    //---- Case -------------------------------------------------------------
    //
    testutil::TCASE(b"Run a distance adjusted ABSMAX search using GFEVNT.", ctx)?;
