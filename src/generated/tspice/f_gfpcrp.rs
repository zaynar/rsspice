...
//$Procedure F_GFPCRP ( Test GF position coordinate progress reporting )
pub fn F_GFPCRP(OK: &mut bool, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    //
    testutil::TCASE(
        b"Run a position coordinate LOCMIN search using GFEVNT.",
        ctx,
    )?;
    ...
    // using the test SPK.
    //
    spicelib::STR2ET(b"2000 JUN 21 01:37:02.472220 TDB", &mut save.CENTRL, ctx)?;
    ...
    //
    testutil::TCASE(
        b"Run a position coordinate ABSMIN search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    testutil::TCASE(
        b"Run a position coordinate LOCMAX search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    testutil::TCASE(
        b"Run a position coordinate ABSMAX search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    testutil::TCASE(
        b"Run a position coordinate > inequality search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    // position coordinate inequality searches require 2 passes.
    //
    ...
    //
    testutil::TCASE(
        b"Run a position coordinate equality search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    // position coordinate equality searches require 2 passes.
    //
    testutil::CHCKSI(b"No. of T_GFRTRM calls", save.NCALLS, b"=", 2, 0, OK, ctx)?;
    ...
    //
    testutil::TCASE(
        b"Run a position coordinate adjusted ABSMIN search using GFEVNT.",
        ctx,
    )?;
    ...
    //
    // position coordinate adjusted absolute extrema searches require 2
    // passes.
    //
    testutil::CHCKSI(b"No. of T_GFRTRM calls", save.NCALLS, b"=", 2, 0, OK, ctx)?;
    ...
    //
    testutil::TCASE(
        b"Run a position coordinate adjusted ABSMAX search using GFEVNT.",
        ctx,
    )?;
