...
//! C$ Abstract
//! C
//! C     Declare parameters specific to SPK type 3.
//! C
//! C$ Disclaimer
//! C
...
//! C                    of a type 3 segment, expressed as seconds past
//! C                    J2000 TDB.
//! C
...
//!
//! C
//! C     End of include file spk03.inc.
//! C     
//! ```
