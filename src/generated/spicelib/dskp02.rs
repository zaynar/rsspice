...
pub fn DSKP02(
    ...
    if ((START < 1) || (START > NP)) {
        ...
        SETMSG(b"Segment in DSK file # with DAS base addresses INT = #, DP = #, CHR = # contains # plates, so START must be in the range 1:#; actual value was #.", ctx);
        ERRFNM(b"#", UNIT, ctx)?;
