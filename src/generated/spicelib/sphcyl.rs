...
/// ```
pub fn sphcyl(radius: f64, colat: f64, slon: f64, r: &mut f64, clon: &mut f64, z: &mut f64) {
    SPHCYL(radius, colat, slon, r, clon, z);
}
...
pub fn SPHCYL(RADIUS: f64, COLAT: f64, SLON: f64, R: &mut f64, CLON: &mut f64, Z: &mut f64) {
    ...
    // temporary variables.
    //
    RR = (RADIUS * f64::sin(COLAT));
    ZZ = (RADIUS * f64::cos(COLAT));
