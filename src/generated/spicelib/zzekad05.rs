        ...
        while (REMAIN > 0) {
            ...
            if (ROOM >= 2) {
                ...
                if FSTPAG {
                    ...
                    DASUDD(HANDLE, DATPTR, DATPTR, &[(NVALS as f64)], ctx)?;
