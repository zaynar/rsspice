...
/// ```
pub fn ncposr(str: &str, chars: &str, start: i32) -> i32 {
    let ret = NCPOSR(str.as_bytes(), chars.as_bytes(), start);
    ret
}

//$Procedure NCPOSR (NOT character position, reverse)
pub fn NCPOSR(STR: &[u8], CHARS: &[u8], START: i32) -> i32 {
    let mut NCPOSR: i32 = 0;
