...
pub fn ZZSPKZP1(
    ...
    if EQSTR(ABCORR, b"NONE") {
        ZZSPKGP1(TARG, ET, REF, OBS, PTARG.as_slice_mut(), LT, ctx)?;
    } else {
        //
        ...
        //
        if (save.TYPE == INERTL) {
            ZZSPKSB1(OBS, ET, REF, save.SOBS.as_slice_mut(), ctx)?;
            ZZSPKPA1(
                TARG,
                ET,
                REF,
        ...
        //
        ZZSPKSB1(OBS, ET, b"J2000", save.SOBS.as_slice_mut(), ctx)?;
        ZZSPKPA1(
            TARG,
            ET,
            b"J2000",
