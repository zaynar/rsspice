    ...
    *BASFRM = 0;
    ...
    if EQSTR(&DYNSTL, KVPARM) {
        ...
        if OFDATE {
            ...
            if (*BASFRM != save.J2000) {
                ZZFRMCH1(save.J2000, *BASFRM, T0, XF2000.as_slice_mut(), ctx)?;
                MXMG(
                    XF2000.as_slice(),
                    XFTEMP.as_slice(),
                    6,
        ...
        //
            ...
            for I in 1..=2 {
                ...
                //
                    ...
                    //
                    if (FRID != save.J2000) {
                        ZZFRMCH1(FRID, save.J2000, VET, XF2000.as_slice_mut(), ctx)?;
                ...
                //
                    ...
                    //
                    ZZFRMCH1(CFRMID, save.J2000, FET, XIPM.as_slice_mut(), ctx)?;
                ...
                //
                    ...
                    if (FRID != save.J2000) {
                        ZZFRMCH1(FRID, save.J2000, FET, XIPM.as_slice_mut(), ctx)?;
        ...
        //
            ...
            ZZFRMCH1(TOID, FROMID, T0, XFORM.as_slice_mut(), ctx)?;
    ...
    if INERT {
        ...
        if (J > 0) {
            ...
            //
            ZZFRMCH1(*BASFRM, save.J2000, T0, XF2000.as_slice_mut(), ctx)?;
