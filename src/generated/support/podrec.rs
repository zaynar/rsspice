...
pub fn PODREC(N: i32, LOC: i32, POD: CharArrayMut, ctx: &mut Context) -> f2rust_std::Result<()> {
    ...
    spicelib::REMLAC(N, (OFFSET + LOC), POD.subarray_mut(1), &mut END, ctx)?;
